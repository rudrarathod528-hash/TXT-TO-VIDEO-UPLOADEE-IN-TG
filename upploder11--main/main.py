...
# === CREDENTIALS (hardcoded defaults — env se override kar sakte ho) ===
api_token = os.getenv("API_TOKEN", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkFQSUtFWSJ9.eyJ1aWQiOjU1NzUwMzI5MDksImp0aSI6Ijk0M2I1NTZmNzQ1OTRlMTdiNGYzMjEyNmM3YWEwZDUwIiwiaWF0IjoxNzgyNDc3MzkyLCJleHAiOjE4MTQwMTMzOTIsImxibCI6IltjbGFzc3BsdXNdIn0.zdpLXfJsFLNNdN1Yl4TNXiCyP-W1fkpM0QfBLQoBLxU")
cwtoken = os.getenv("CW_TOKEN", "eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiJ9..ONBsbnNwCQQtKMK2h18LCi73e90s2Cr63ZaIHtYueM-Gt5Z4sF6Ay-SEaKaIf1ir9ThflrtTdi5eFkUGIcI78R1stUUch_GfBXZsyg7aVyH2wxm9lKsFB2wK3qDgpd0NiBoT-ZsTrwzlbwvCFHhMp9rh83D4kZIPPdbp5yoA_06L0Zr4fNq3S328G8a8DtboJFkmxqG2T1yyVE2wLIoR3b8J3ckWTlT_VY2CCx8RjsstoTrkL8e9G5ZGa6sksMb93ugautin7GKz-nIz27pCr0h7g9BCoQWtL69mVC5xvVM3Z324vo5uVUPBi1bCG-ptpD9GWQ4exOBk9fJvGo-vRg")
cptoken = os.getenv("CP_TOKEN", "")   # classplus API token (optional — /drm flow me diya token use hota hai)
    ...
    try:
        for i in range(arg-1, len(links)):
            ...
            if "acecwply" in url:
                ...
                url = requests.get(f'https://api.classplusapp.com/cams/uploader/video/jw-signed-url?url={url}', headers={'x-access-token': f'{cptoken or raw_text4}'}).json()['url']
